                                ...
                                <div class="contact-info">
                                    ...
                                    <span class="contact-icon">
                                        ...
                                        <a href="mailto:your@example.com" class="contact-text">
                                            <strong>Địa chỉ:</strong> Bắc Từ Liêm - Hà Nội.
                                        </a>
                                    </div>
                                    <div class="single-contact-info">
                                    <span class="contact-icon">
                                        ...
                                        <a href="mailto:your@example.com" class="contact-text">
                                            <strong>Số Điện thoại:</strong> (+84) 0866076558
                                        </a>
                                    </div>
                                    <div class="single-contact-info">
                                    <span class="contact-icon">
                                        ...
                                        <a href="mailto:your@example.com" class="contact-text">
                                            <strong>Email:</strong>duckhainguyenn2003@gmail.com
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><img src="assets_fontend/img/icons/cancel.png" alt="Close" class="img-fluid"/></span>
            </button>
                                ...
                                <div class="product-thumb-carousel owl-carousel">
                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets_fontend/img/single-pro-1.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets_fontend/img/single-pro-2.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets_fontend/img/single-pro-3.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets_fontend/img/single-pro-4.jpg"
                                                                           alt="Product"/></a>
                                    </div>
                                </div>
                            </div>
